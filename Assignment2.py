...
# Take elements from WS1.txt file
...
# create empty list to store scores from sentiment analysis
score = []

# perform sentiment analysis on purposes of companies
...
# add score list to final data frame
finalData["score"] = score

# reorder companies in descending order
